...
public class CarrinhoController {
    ...
    @Transactional   // 🔥 MANTÉM A SESSÃO DO HIBERNATE ATÉ O FINAL DO MÉTODO
    ...
    public String finalizarAluguel(HttpSession session,
        ...
        // 🔥 NÃO VAI MAIS GERAR ERRO AQUI
        for (Emprestimo emp : emprestimosCriados) {
            if (emp.getLivro().getCategoria() != null) {
                emp.getLivro().getCategoria().getNome();
            }
        }
        ...
        return "emprestimos/aluguel-confirmado";
    }
